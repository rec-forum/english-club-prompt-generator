document.addEventListener('DOMContentLoaded', () => {
    ...
    const topicPools = {
        currentEvents: [
            "Future of Work & Remote Trends (未來工作與遠距趨勢)",
            "Global Economic Shifts (全球經濟變遷)",
            "Climate Change & Sustainability (氣候變遷與永續發展)",
            "Artificial Intelligence in Society (AI 在社會的應用)",
            "Privacy & Cybersecurity (隱私與網路安全)",
            "Public Health & Medical Breakthroughs (公共衛生與醫療突破)",
            "Space Exploration & Tech (太空探索科技)",
            "Demographic Changes & Aging Society (人口結構變遷與高齡化社會)",
            "Social Media & Digital Culture (社群媒體與數位文化)",
            "Urban Planning & Smart Cities (都市規劃與智慧城市)",
            "Transportation & Self-Driving Vehicles (交通與自駕車)",
        ...
        fun: [
            ...
            "Cultural Traditions & Global Festivals (文化傳統與全球節慶)",
            "History of Common Items (日常事物的歷史)",
            "Travel Trends & Tourism (旅遊趨勢與觀光)",
            "Sports & Human Performance (體育與人體潛能)",
            "Entertainment & Pop Culture (娛樂與流行文化)",
            "Language & Communication (語言與溝通)",
            "Pets & Animal Behavior (寵物與動物行為)",
            "Art, Design & Architecture (藝術、設計與建築)",
        ...
        tech: [
            ...
            "Consumer Electronics & Gadgets (消費電子與穿戴裝置)",
            "Robotics & Automation (機器人與自動化)",
            "Biotechnology & Genetics (生物科技與基因學)",
            "The Future of the Internet & Web3 (網路未來與 Web3)",
            "Virtual Reality & Augmented Reality (VR 與 AR)",
        ...
        life: [
            ...
            "Diet, Nutrition & Wellness (飲食、營養與健康)",
            "Mindfulness & Mental Health (正念與心理健康)",
            "Work-Life Balance (工作與生活平衡)",
            "Nature & Outdoor Activities (大自然與戶外活動)",
            "Digital Detox & Screen Time (數位排毒與螢幕時間)",
        ...
        business: [
            ...
            "Workplace Culture & Leadership (職場文化與領導力)",
            "Consumer Behavior & Marketing (消費者行為與行銷)",
            "Personal Finance & Investing (個人理財與投資)",
            "The Gig Economy & Freelancing (零工經濟與自由工作者)",
            "E-commerce & Retail Trends (電子商務與零售趨勢)",
